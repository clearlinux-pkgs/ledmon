...
Version  : 0.95
Release  : 5
URL      : https://github.com/intel/ledmon/archive/0.95/ledmon-0.95.tar.gz
Source0  : https://github.com/intel/ledmon/archive/0.95/ledmon-0.95.tar.gz
...
%prep
%setup -q -n ledmon-0.95
cd %{_builddir}/ledmon-0.95
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652075307
...
cp %{_builddir}/ledmon-0.95/COPYING %{buildroot}/usr/share/package-licenses/ledmon/74a8a6531a42e124df07ab5599aad63870fa0bd4
%make_install
