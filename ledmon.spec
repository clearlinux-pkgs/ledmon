...
%prep
%setup -q -n ledmon-0.96
cd %{_builddir}/ledmon-0.96
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654191513
...
cp %{_builddir}/ledmon-0.96/COPYING %{buildroot}/usr/share/package-licenses/ledmon/74a8a6531a42e124df07ab5599aad63870fa0bd4
%make_install
